...
public class PreviewPopUpWord extends AppCompatActivity {
    ...
    private TextView previewPopUpWordView;
    private TextView previewWordEdit;
    String json;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preview_pop_up_word);
        previewPopUpWordView.findViewById(R.id.previewPopUpWordView);
        previewWordEdit.findViewById(R.id.previewWordEdit);
        String getTitle = getIntent().getStringExtra("Title");
        String getmembershipNumber = getIntent().getStringExtra("membershipNumber");
        previewWordEdit.setText(getTitle);
    ...
    private void getResult(String json) { // type == 0 그냥 쿼리문 // 1: list 반환
        ...
        try {
            ...
            for (int i = 0; i < 5; i++) {
                ...
                previewWordEdit.setText(spel+'\n');
                previewWordEdit.setText(mean+'\n');
                previewWordEdit.setText(sent+"\n\n");
            }
