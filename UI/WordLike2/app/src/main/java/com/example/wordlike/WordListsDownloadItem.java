...
public class WordListsDownloadItem extends AppCompatActivity {
    private RecyclerAdapter adapter;
    private TextView WordListDownloadView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_word_lists_download_item);
        WordListDownloadView.findViewById(R.id.wordListsDownloadView);
        ...
        WordListDownloadView.setText(getTitle);
    ...
    private void getResult(String json) { // type == 0 그냥 쿼리문 // 1: list 반환
        ...
        try {
            ...
            for (int i = 0; i < 5; i++) {
                ...
                content.setText(spel+'\n');
                content.setText(mean+'\n');
                content.setText(sent+"\n\n");
            }
